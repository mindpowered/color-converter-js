...
$hx_exports["colorconverter"] = $hx_exports["colorconverter"] || {};
...
class colorconverter_ColorConverter {
	...
	registerMyMethods() {
		let bus = this.maglev;
		this.maglev.register("ColorConverter.FromRGB",maglev_MagLevFunction.fromFunction(function(args) {
			...
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FromRGB' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.FromCIELAB",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.FromCIELAB"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FromCIELAB' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.FromCMYK",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.FromCMYK"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FromCMYK' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.FromHEX",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.FromHEX"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FromHEX' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.FromXYZ",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.FromXYZ"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FromXYZ' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.ConvertRGB",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.ConvertRGB"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.ConvertRGB' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.ConvertCIELAB",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.ConvertCIELAB"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.ConvertCIELAB' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.ConvertCMYK",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.ConvertCMYK"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.ConvertCMYK' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.ConvertHEX",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.ConvertHEX"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.ConvertHEX' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.ConvertXYZ",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.ConvertXYZ"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.ConvertXYZ' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.AddReferenceColorByRGB",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.AddReferenceColorByRGB"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.AddReferenceColorByRGB' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.AddReferenceColorByCIELAB",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.AddReferenceColorByCIELAB"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.AddReferenceColorByCIELAB' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.AddReferenceColorByCMYK",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.AddReferenceColorByCMYK"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.AddReferenceColorByCMYK' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.AddReferenceColorByHEX",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.AddReferenceColorByHEX"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.AddReferenceColorByHEX' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.AddReferenceColorByXYZ",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.AddReferenceColorByXYZ"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.AddReferenceColorByXYZ' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.FindReferenceColorByRGB",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.FindReferenceColorByRGB"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FindReferenceColorByRGB' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.FindReferenceColorByCIELAB",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.FindReferenceColorByCIELAB"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FindReferenceColorByCIELAB' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.FindReferenceColorByCMYK",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.FindReferenceColorByCMYK"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FindReferenceColorByCMYK' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.FindReferenceColorByHEX",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.FindReferenceColorByHEX"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FindReferenceColorByHEX' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.FindReferenceColorByXYZ",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.FindReferenceColorByXYZ"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FindReferenceColorByXYZ' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.FindReferenceColor",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.FindReferenceColor"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.FindReferenceColor' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.RemoveReferenceColorSystem",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.RemoveReferenceColorSystem"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.RemoveReferenceColorSystem' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.GetReferenceColorSystems",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.GetReferenceColorSystems"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.GetReferenceColorSystems' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.GetReferenceColors",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.GetReferenceColors"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.GetReferenceColors' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.GetIlluminationObserverAngles",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.GetIlluminationObserverAngles"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.GetIlluminationObserverAngles' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.SaveReferenceColors",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.SaveReferenceColors"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.SaveReferenceColors' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
		this.maglev.register("ColorConverter.LoadReferenceColors",maglev_MagLevFunction.fromFunction(function(args) {
			let data = maglev_MagLevArray.create();
			data.push(maglev_MagLevString.fromString("_not_implemented_"));
			data.push(maglev_MagLevString.fromString("ColorConverter.LoadReferenceColors"));
			data.push(maglev_MagLevString.fromString("colorconverter"));
			bus.call("MindPowered.Telemetry.Send",data);
			let err = maglev_MagLevError.create(-20000,"You are trying to use the 'ColorConverter.LoadReferenceColors' method but it's not quite done yet. Please email support@mindpowered.dev to find out when it will be done.",data);
			let result = maglev_MagLevResult.fromError(err);
			return result;
		}));
	}
}
$hxClasses["colorconverter.ColorConverter"] = $hx_exports["colorconverter"]["ColorConverter"] = colorconverter_ColorConverter;
colorconverter_ColorConverter.__name__ = "colorconverter.ColorConverter";
Object.assign(colorconverter_ColorConverter.prototype, {
	__class__: colorconverter_ColorConverter
	,maglev: null
});
...
var colorconverter = $hx_exports["colorconverter"];
